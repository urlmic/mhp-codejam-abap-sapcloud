CLASS zmhp_cl_travel_auxiliary_xxx DEFINITION
...
*   Type definition for import parameters --------------------------
    TYPES tt_travel_create              TYPE TABLE FOR CREATE   /dmo/i_travel_u. "ZI_MHP_TRAVEL_U_XXX
    TYPES tt_travel_update              TYPE TABLE FOR UPDATE   /dmo/i_travel_u. "ZI_MHP_TRAVEL_U_XXX
    TYPES tt_travel_delete              TYPE TABLE FOR DELETE   /dmo/i_travel_u. "ZI_MHP_TRAVEL_U_XXX

    TYPES tt_travel_failed              TYPE TABLE FOR FAILED   /dmo/i_travel_u. "ZI_MHP_TRAVEL_U_XXX
    TYPES tt_travel_mapped              TYPE TABLE FOR MAPPED   /dmo/i_travel_u. "ZI_MHP_TRAVEL_U_XXX
...
PRIVATE SECTION.
    ...
    CLASS-DATA obj TYPE REF TO zmhp_cl_travel_auxiliary_xxx.

    CLASS-METHODS get_message_object
         RETURNING VALUE(r_result)          TYPE REF TO zmhp_cl_travel_auxiliary_xxx.
...
CLASS ZMHP_CL_TRAVEL_AUXILIARY_XXX IMPLEMENTATION.
