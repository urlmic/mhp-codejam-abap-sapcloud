@AbapCatalog.sqlViewName: 'ZIMHPTRAVELUXXX'
...
define view ZI_MHP_TRAVEL_U_XXX
  as select from /dmo/travel as Travel -- the travel table is the data source for this view

  association [0..*] to ZI_MHP_BOOKING_U_XXX as _Booking  on $projection.TravelID = _Booking.TravelID
